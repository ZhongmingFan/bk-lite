    ...
    async def collect(self) -> str:
        ...
        metric_dict = {
            (organization_id, "meraki_wireless_inventory"): {
                ...
                "meraki_wireless_ap_count": _gauge(len(ethernet)),
            }
        }
        for item in ethernet:
            ...
            for port in item.get("ports") or []:
                ...
                link_up = 1 if (speed is not None and speed > 0) or duplex in {"full", "half"} else 0
                dims = [("port", port_name)]
