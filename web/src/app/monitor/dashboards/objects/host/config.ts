...
export const HOST_DASHBOARD_CONFIG: SimpleDashboardConfig = {
  ...
  metrics: [
    ...
    },
    {
      ...
      description: '主机内存使用率。',
      unit: 'percent',
      query: 'mem_used_percent{instance_type="os", __$labels__} or host_mem_used_percent_gauge{instance_type="os", __$labels__} or mem_used_percent_gauge_value{instance_type="os", config_type="windows_wmi", __$labels__} or mem_used_percent_gauge{instance_type="os", config_type=~"host_(aix|solaris)_remote", __$labels__}',
      color: HOST_PALETTE.emerald
    },
    {
